...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private String categoryName, Description, Price, ProductName, saveCurrentDate, saveCurrentTime, city, phoneNumber, ProductRandomKey;
    private String downloadImageUrl;
    private ImageView productImage;
    private EditText productName, productDescription, productPrice, productCity, productPhoneNumber;
    ...
    private void ValidateProductData() {
        ...
        city = productCity.getText().toString();
        phoneNumber = productPhoneNumber.getText().toString();

        if (ImageUri == null) {
            Toast.makeText(this, "Выберите изображение товара, нажав на картинку", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "Напишите город", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(phoneNumber)) {
            Toast.makeText(this, "Напишите номер телефона", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void SaveProductInfoToDatabase() {
        ...
        productMap.put("phone", phoneNumber);
        ...
        ProductsRef.child(ProductRandomKey).updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()) {
                    ...
                    Intent backToCategoryActivity = new Intent(AdminAddNewProductActivity.this, AdminCategoryActivity.class);
    ...
    public void init() {
        ...
        productCity = findViewById(R.id.product_city);
        productPhoneNumber = findViewById(R.id.product_call_number);
